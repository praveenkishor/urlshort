...
import "./Landing.css";
import { createShortUrl, fetchShortUrl} from "../../APIHelper";
  ...
  render() {
    return (
      <div className="landing">
        <div>
          <h5> Please enter your url here</h5>
        </div>
        <div>
          Ex:{" "}
        ...
        {this.state.present && (
          <div className="shorten-error">Already available</div>
        )}
        {this.state.showShortenUrl && (
          <div className="shorten-title">
            Shortened Url is :{` `}
            <a target="_blank" onClick={this.countClick} href={this.state.originalUrl}>
